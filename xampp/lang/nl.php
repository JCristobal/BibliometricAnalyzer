...
$TEXT['security-text2']="De groen gemarkeerde punten zijn veilig; de rood gemarkeerde punten zijn absoluut onveilig en de geel gemarkeerde punten konden niet gecontroleerd worden (bv. omdat de software tbv de controle niet draait).<p>Om deze zaken op te lossen, of af te sluiten: voer het volgende commande uit <p><b>/opt/lampp/xampp security</b><p>Dit start een interactief  programma.";
...
<li><a href=http://dev.mysql.com/doc/refman/5.6/en/>MySQL documentatie</a>
