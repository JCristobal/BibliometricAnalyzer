...
$TEXT['security-text2']="Les points marqués en verts sont securisés; les points marqués en rouge sont définitivement insécurisés et les points marqués en jaune n'ont pas pu être vérifiés (ex: parce que le logiciel de vérification n'est pas lancé).<p>Pour réparer ou fermer tous ces objets appelez simplement <p><b>/opt/lampp/xampp security</b><p>Ceci démarrera un programme intéractif.";
...
<li><a href=http://dev.mysql.com/doc/refman/5.6/en/>Documentation MySQL</a>
