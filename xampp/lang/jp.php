...
$TEXT['security-text2']="緑のハイライトの表示は「安全」です。赤のハイライトの表示は、決定的に「要注意」、黄色のハイライトは「確認不能」(例えば、確認したいソフトウェアが稼動していないなど)です。<p>そのような問題をすべて修正するには、単純に<p><b>/opt/lampp/xampp security</b><p>をコールしてください。インタラクティブなプログラムが開始されます。";
...
<li><a href=http://dev.mysql.com/doc/refman/5.6/en/>MySQL ドキュメント</a>
